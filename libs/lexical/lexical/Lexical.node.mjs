...
export const IS_NORMAL = mod.IS_NORMAL;
export const IS_SEGMENTED = mod.IS_SEGMENTED;
...
export const IS_TOKEN = mod.IS_TOKEN;
...
export const getActiveEditor = mod.getActiveEditor;
