...
export function isDropboxResponseError<T extends object>(
  ...
  return (
    ...
    error !== null &&
    "error" in error &&
    typeof (error as DropboxResponseError<DropboxError<T>>).error ===
      "object" &&
    ...
    typeof (error as DropboxResponseError<DropboxError<T>>).error.error ===
      "object" &&
...
export type DropboxFileMetadataErrorResponse = DropboxResponseError<
  DropboxError<DropboxUploadSmallFileError>
>;

export type DropboxUploadSessionStartError = files.UploadSessionStartError;
export type DropboxUploadSessionStartErrorResponse = DropboxResponseError<
  DropboxError<DropboxUploadSessionStartError>
>;

export type DropboxUploadSessionAppendError = files.UploadSessionAppendError;
export type DropboxUploadSessionAppendErrorResponse = DropboxResponseError<
  DropboxError<DropboxUploadSessionAppendError>
>;

export type DropboxUploadSessionFinishError = files.UploadSessionFinishError;
export type DropboxUploadSessionFinishErrorResponse = DropboxResponseError<
  DropboxError<DropboxUploadSessionFinishError>
>;

export type DropboxUploadError =
...
export type DropboxDownloadErrorResponse = DropboxResponseError<
  DropboxError<DropboxDownloadError>
>;

export type DropboxGetMetadataError = files.GetMetadataError;
export type DropboxGetMetadataErrorResponse = DropboxResponseError<
  DropboxError<DropboxGetMetadataError>
>;

export type DropboxDeleteError = files.DeleteError;
export type DropboxDeleteErrorResponse = DropboxResponseError<
  DropboxError<DropboxDeleteError>
>;

export type DropboxCreateSharedLinkWithSettingsError =
  sharing.CreateSharedLinkWithSettingsError;
...
export const DropboxWriteModeOverwrite: files.WriteModeOverwrite = {
  ".tag": "overwrite",
};
export const DropboxLinkAudiencePublic: sharing.LinkAudiencePublic = {
  ".tag": "public",
};
