...
import { $isLayoutBodyNode, LayoutBodyNode, LayoutNode } from "../../nodes/layout";
import { HTMLTableElementWithWithTableSelectionState, TableObserver, applyTableHandlers } from "@lexical/table";
...
export function LayoutPlugin() {
    ...
    useEffect(
        () => {
            assert( editor.hasNodes([LayoutNode, LayoutBodyNode]), "LayoutNode, LayoutBodyNode not registerd in editor" );
        },
        [editor]
    );
